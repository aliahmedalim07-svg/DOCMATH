...
import { MistakesTracker } from "../../components/dashboard/MistakesTracker";
import { useParentDashboard } from "./ParentDashboardLayout";
import { useI18n } from "../../contexts/I18nContext";

export default function ParentMistakes() {
  const { t } = useI18n();
  ...
  return <MistakesTracker mistakes={dashboardData.mistakes} />;
}
